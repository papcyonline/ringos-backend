...
export async function createNotification(data: {
  userId: string;
  type: 'CHAT_MESSAGE' | 'VOICE_NOTE' | 'NEW_FOLLOWER' | 'PROFILE_LIKED' | 'MATCH_FOUND' | 'STORY_GIFT' | 'STORY_LIKED' | 'STORY_VIEWED' | 'STORY_MILESTONE' | 'MISSED_CALL' | 'SYSTEM' | 'POST_LIKED' | 'POST_COMMENTED' | 'POST_MENTION' | 'NEW_POST' | 'NEW_STORY' | 'MESSAGE_REQUESTS_DIGEST' | 'NEW_FOLLOWERS_DIGEST' | 'ADDED_TO_GROUP' | 'REEL_COMMENT_MENTION';
  title: string;
  body: string;
  imageUrl?: string;
